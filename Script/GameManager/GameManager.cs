...
public partial class GameManager : MonoBehaviour
{
    ...
    public static string s_speed = "Speed",s_rot = "Rot",s_state_change = "State_Change",s_state_type = "State_Type"
        ...
        ,s_fadeamount = "_FadeAmount",s_chromaberramount = "_ChromAberrAmount"
        ,s_radius = "_radius",s_size = "_size",s_wavesize = "_wavesize",s_position = "_position",s_125ms = "125ms"
        ,s_action = "Action",s_combobegin = "콤보 시작",s_truecombo = "확정 콤보",s_smash = "강력한 공격",s_combofinish = "콤보 마무리",s_kill = "적 처치"
        ,s_normalattack = "첫번째 공격",s_continuousattack = "연속 공격",s_counter = "카운터 성공",s_evade = "완벽한 회피",s_superarmor = "슈퍼아머"
