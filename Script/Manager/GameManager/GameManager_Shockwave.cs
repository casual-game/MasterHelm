...
public partial class GameManager : MonoBehaviour
{
    ...
    public void Shockwave(Vector3 pos,float duration = 1.25f,float waveSize = 0.125f,float saturation =0,Ease ease = Ease.Linear)
    {
        t_shockwave.Stop();
        mat_shockwave.SetFloat(s_radius, 0.225f);
        ...
        t_shockwave = Tween.MaterialProperty(mat_shockwave,properyID ,1.0f, duration,useUnscaledTime:true,ease:ease);
    }
}
